...
### Использование первичных конструкторов суперкласса
...
Требования:
- Создайте абстрактный класс  `Shape`  для представления абстрактных площадных графических фигур:
	- Должны быть объявлены следующие свойства:
		-   `x`,  `y`  координаты базовой точки
		-   `color`  (цвет фигуры)
	- Должен быть реализован первичный конструктор
...
- Создайте класс  `Rectangle`, расширяющий класс  `Shape`, для представления прямоугольников:
	- Должны быть объявлены следующие свойства:
