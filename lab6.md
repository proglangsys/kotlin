...
- **Анализ данных с использованием списков пар и троек.** Имеется список транзакций, где каждая транзакция представлена парой (дата, сумма). Необходимо выполнить следующие задачи:
	1.  Найти общую сумму всех транзакций.
	2.  Найти самую крупную транзакцию и вывести её дату и сумму.
	3.  Найти среднюю сумму транзакций.
	4.  Сгруппировать транзакции по месяцам и найти общую сумму транзакций для каждого месяца. Результат должен быть представлен в виде списка троек (год, месяц, общая сумма).
...
- **Анализ данных с использованием ассоциативный массив.** Имеется ассоциативный массив продаж, где ключами являются названия товаров, а значениями — списки пар (дата продажи, количество проданных единиц). Необходимо выполнить следующие задачи:
	1. Найти товар, который был продан наибольшее количество раз.
	2.  Найти товар, который принес наибольшую выручку (предположим, что у каждого товара есть фиксированная цена).
	3.  Вывести статистику по продажам за каждый месяц (общее количество проданных единиц и общая выручка).
